...
[_ADJUST] =  LAYOUT_ortho_4x12( \
  ...
  _______, _______, _______, AU_ON,   AU_OFF,  _______, _______, WINDOWS, MACOS  , _______, _______, _______, \
  _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, \
  _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______ \
)
...
#ifdef AUDIO_ENABLE
float tone_qwerty[][2]     = SONG(WINDOWS_SOUND);
